 ...
 * <code>{@link QueryRequestRecoverer#processRequests(List)}</code>.  Specifically, it holds the
        ...
        ) 
{
     ...
     * </p>
     * <p>
     * First the given <code>TestConfig</code> record is used to configure the given <code>QueryRequestRecoverer</code> instance.
     * Then the given <code>DpDataRequest</code> is used for the <code>{@link QueryRequestRecoverer#processRequest(DpDataRequest)</code>
     * operation. 
     ...
     */
    public ConfigResult  evaluate(QueryRequestRecoverer prcrRqsts, TestConfig recPrcrCfg) throws DpQueryException {
