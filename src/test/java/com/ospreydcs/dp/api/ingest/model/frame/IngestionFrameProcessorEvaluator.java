 ...
 *
 */
public class IngestionFrameProcessorEvaluator {
...
//        final boolean   bolConcurrency = false;
    ...
    public final void testSubmitListOfIngestionFrameTake() {
        ...
        IngestionFrameProcessorEvalResults     results = new IngestionFrameProcessorEvalResults();
        results.start();
        ...
        // Create processor 
        IngestionFrameProcessor processor = config.createProcessor();
        ...
        results.printAll(System.out, processor, JavaRuntime.getQualifiedCallerNameSimple());
    }    
...
//        os.println("  Creation time       : " + durPayload);
     ...
     * @param strHdr    optional header line to be included in description if (non-<code>null</code>)
     */
    private void    printTestActivity(PrintStream os, IngestionFrameProcessorEvalResults results, String strHdr) {
     ...
     * @param strHdr    optional header line to be included in description if (non-<code>null</code>)
     */
    private void    printTestResults(PrintStream os, IngestionFrameProcessorEvalResults results, String strHdr) {
