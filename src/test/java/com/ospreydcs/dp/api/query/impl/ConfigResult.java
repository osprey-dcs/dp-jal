 ...
 * <code>{@link QueryRequestProcessorNew#processRequest(DpDataRequest)}</code> operation.
 * </p>
 * <p>
        ...
        List<DpDataRequest> lstCmpRqsts) 
{
     ...
     * @param cntBlocks     number of correlated data blocks produced
     * @param durRequest    the duration required for the request recover and processing
     * @param recConfig     the test configuration for the <code>QueryRequestProcessorNew</code> 
     * @param request       the time-series data request used in the test
     * @param lstCmpRqsts   the composite requests generated by the request processor 
     * 
     ...
     * is deferred to method <code>{@link #evaluate(QueryRequestProcessorNew, DpDataRequest, TestConfig)}</code>.
     * <ol>
     * <li>
     ...
     * </li>
     * <li>
     * Second, the method <code>{@link #evaluate(QueryRequestProcessorNew, DpDataRequest, TestConfig)}</code> is invoked
     ...
     * </li>
     * <li>
     * Last, the result from the <code>{@link #evaluate(QueryRequestProcessorNew, DpDataRequest, TestConfig)}</code> invocation
     * is returned.
     * </li>
     * </ol>
     * </p>
     ...
     * @see #evaluate(QueryRequestProcessorNew, DpDataRequest, TestConfig)
     */
    public static ConfigResult  evaluate(QueryRequestProcessorNew prcrRqsts, DpDataRequest rqst, DpGrpcStreamType enmStrmType, TestConfig recPrcrCfg) throws DpQueryException {
     ...
     * </p>
     * <p>
     * First the given <code>TestConfig</code> record is used to configure the given <code>QueryRequestProcessorNew</code> 
     ...
     * @throws DpQueryException general Query Service exception during request processing (see message and cause)
     */
    public static ConfigResult  evaluate(QueryRequestProcessorNew prcrRqsts, DpDataRequest rqst, TestConfig recPrcrCfg) throws DpQueryException {
