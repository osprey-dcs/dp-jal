 ...
 * File:	QueryRequestProcessorOldTest.java
 * Package: com.ospreydcs.dp.api.query.impl
 * Type: 	QueryRequestProcessorOldTest
 *
...
/**
 * <p>
 * JUnit test cases and performance evaluations for class <code>QueryRequestProcessorOld</code>.
 * </p>
 *
 * @author Christopher K. Allen
 * @since Jan 23, 2025
 *
 */
public class QueryRequestProcessorOldTest {
...
//    /**
//     * <p>
//     * Record containing all the configuration parameters for a <code>QueryRequestProcessorOld</code> test request.
//     * </p>
//     *
...
//    /**
//     * <p>
//     * Record containing the results of a <code>{@link QueryRequestProcessorOld#processRequest(DpDataRequest)}</code> operation
...
//
//            os.println(strPad + "QueryRequestProcessorOld Configuration");
...
//             * </p>
//             * 
//             * @param recCfg  <code>TestConfig</code> record under comparison
//             * 
...
//             */
//            public boolean  isIndex(Index recIndex) {
...
//    public static final List<Integer>           LST_MSTRM_CNT_STRMS = List.of(1, 2, 3, 4, 5);
    ...
    @SuppressWarnings("deprecation")
    private static QueryRequestProcessorOld   prcrQuery;
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        prcrQuery = QueryRequestProcessorOld.from(connQuery);
        
        // Open the common output file
        String  strFileName = QueryRequestProcessorOldTest.class.getSimpleName() + "-" + Instant.now().toString() + ".txt";
        ...
        psOutput.println(QueryRequestProcessorOldTest.class.getSimpleName() + ": " + strDateTime);
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#from(com.ospreydcs.dp.api.grpc.query.DpQueryConnection)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    public final void testFrom() {
        QueryRequestProcessorOld  prcrTest = QueryRequestProcessorOld.from(connQuery);
        
        Assert.assertNotNull(prcrTest);
    }

    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#QueryResponseProcessor(com.ospreydcs.dp.api.grpc.query.DpQueryConnection)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    public final void testQueryResponseProcessor() {
        QueryRequestProcessorOld  prcrTest = new QueryRequestProcessorOld(connQuery);
        
        Assert.assertNotNull(prcrTest);
    }

    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#enableMultiStreaming(boolean)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#setMultiStreamingDomainSize(long)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#setMaxStreamCount(int)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#setMaxDataSourceCount(int)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#setMaxTimeRange(java.time.Duration)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#enableCorrelateConcurrently(boolean)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#enableCorrelateWhileStreaming(boolean)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#processRequest(com.ospreydcs.dp.api.query.DpDataRequest)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    public final void testProcessRequest() {
        ...
        final QueryRequestProcessorOld    prcrTest = QueryRequestProcessorOld.from(connQuery);
        ...
        for (TestConfig recCfg : LST_CFG_TEST_CASES) { 
            ...
            for (DpDataRequest rqst : LST_RQSTS) {
                ...
                try {
                    ...
                    SortedSet<CorrelatedQueryDataOld>  setData = prcrTest.processRequest(rqst);
...
//                    ConfigResult    recResult = ConfigResult.from(dblRateXmit, indCase, cntMsgs, szAlloc, cntBlks, durRqst, recCfg, rqst, strRqstNm, lstCmpRqsts);
    ...
    /**
     * Test method for {@link com.ospreydcs.dp.api.query.impl.QueryRequestProcessorOld#processRequests(java.util.List)}.
     */
    @Test
    @SuppressWarnings("deprecation")
    public final void testProcessRequests() {
        ...
        QueryRequestProcessorOldTest.prcrQuery.enableMultiStreaming(bolMultStrm);
        QueryRequestProcessorOldTest.prcrQuery.enableCorrelateConcurrently(bolCorrCon);
        QueryRequestProcessorOldTest.prcrQuery.enableCorrelateWhileStreaming(bolCorrStrm);
        
        int     indCase = 1;
        for (TestCase recCase : LST_MSTRM_TST_CASES) {
        
            System.out.println("Test Case #" + indCase);
            os.println("Test Case #" + indCase);
            try {
                
                Instant insStart = Instant.now();
                SortedSet<CorrelatedQueryDataOld>  setData = QueryRequestProcessorOldTest.prcrQuery.processRequests(recCase.lstCmpRqsts());
                Instant insFinish = Instant.now();
                
                // Compute results
                Duration    durRqst = Duration.between(insStart, insFinish);
                int         cntMsgs = QueryRequestProcessorOldTest.prcrQuery.getProcessedMessageCount();
                int         cntBlks = setData.size();
                long        szAlloc = QueryRequestProcessorOldTest.prcrQuery.getProcessedByteCount();
    ...
    private void    dealWithProcessRequestResults(PrintStream os, final SortedSet<ConfigResult>   setResults) {
        ...
        ConfigResultScore       scoreBestAboveMin = new ConfigResultScore(LST_RQSTS);
