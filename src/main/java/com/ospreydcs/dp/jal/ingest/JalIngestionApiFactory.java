 ...
 * Package: com.ospreydcs.dp.jal.ingest
...
import com.ospreydcs.dp.jal.ingest.impl.JalIngestionServiceFactory;
import com.ospreydcs.dp.jal.ingest.impl.JalIngestionStreamFactory;
 ...
 * <ol>
 * <li>
 * <code>{@link IIngestionService}</code> - Supports unary RPC data ingestion. 
 * </li>
 * <li>
 * <code>{@link IIngestionStream}</code> - Supports gRPC streaming data ingestion.
 * </li> 
 * </ol>
 * Both interfaces use <code>{@link IngestionFrame}</code> instances as the unit of ingestion.
 * </p>
 * <p>
...
public class JalIngestionApiFactory {
     ...
     * </p>
     * 
     * @return  new, connected <code>IIngestionService</code> implementation ready for data ingestion
     * 
...
//        return apiService;
    ...
    /**
     * <p>
     * Create and return a connected Ingestion Service interface connected to given service address.
     * </p>
     * <p>
...
//        return apiService;
    ...
    /**
     * <p>
     * Create and return a connected Ingestion Service interface connected to given service address with plain text 
     * transmission option.
     * </p>
     * <p>
...
//        return apiService;
    ...
    /**
     * <p>
     * Create and return a connected Ingestion Service interface with all connection parameters specified.
     * </p>
     * <p>
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionService    connectService(String strHostUrl, 
                                                      int intHostPort, 
    ...
    /**
     * <p>
     * Create and return a connected Ingestion Service interface connected to the given Ingestion Service
     * host using the given explicit security parameters.
     * </p>
     * <p>
     * The returned instance is connected to the Ingestion Service server at the given URL and and port address. 
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionService connectService(String strHostUrl, int intHostPort, File fileTrustedCerts, File fileClientCerts, File fileClientKey) throws DpGrpcException {
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionService connectService(
            String  strHost, 
            int     intPort, 
     ...
     * </p>
     * 
     * @return  new, connected <code>IIngestionStream</code> implementation ready for data ingestion
     * 
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream() throws DpGrpcException {
        return FAC_STREAM.connect();
    }
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream(String strHostUrl, int intHostPort) throws DpGrpcException {
        return FAC_STREAM.connect(strHostUrl, intHostPort);
    }
    
    /**
     * <p>
     * Create and return a connected Ingestion Service interface connected to given service address 
     * with plain text transmission option.
     * </p>
     * <p>
     * The use of "plain text" data transmission mode is available for network debugging.  In general this option
     * should be avoided due to lack of security and its poor performance. 
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream    connectStream(String strHostUrl, int intHostPort, boolean bolPlainText) throws DpGrpcException {
        return FAC_STREAM.connect(strHostUrl, intHostPort, bolPlainText);
    }
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream(String strHostUrl, int intHostPort, boolean bolPlainText, long lngTimeout, TimeUnit tuTimeout) throws DpGrpcException {
        return FAC_STREAM.connect(strHostUrl, intHostPort, bolPlainText, lngTimeout, tuTimeout);
    }
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream(String strHostUrl, 
                                                      int intHostPort, 
                                                      boolean bolTisActive, 
                                                      boolean bolPlainText, 
                                                      int intMsgSizeMax, 
                                                      ...
                                                      long lngTimeout, 
                                                      TimeUnit tuTimeout) throws DpGrpcException {
        return FAC_STREAM.connect(strHostUrl, intHostPort, bolTisActive, bolPlainText, intMsgSizeMax, bolKeepAlive, bolGzipCompr, lngTimeout, tuTimeout);
    }
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream(File fileTrustedCerts, File fileClientCerts, File fileClientKey) throws DpGrpcException {
        return FAC_STREAM.connect(fileTrustedCerts, fileClientCerts, fileClientKey);
    }
    
    /**
     * <p>
     * Create and return a connected Ingestion Service interface connected to the given Ingestion Service
     * host address using the given explicit security parameters.
     * </p>
     * <p>
     * The returned instance is connected to the Ingestion Service server at the given URL and and port address. 
     * It has all default connection parameters, has all default interface configuration parameters, and uses the 
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream  connectStream(String strHostUrl, int intHostPort, File fileTrustedCerts, File fileClientCerts, File fileClientKey) throws DpGrpcException {
        return FAC_STREAM.connect(strHostUrl, intHostPort, fileTrustedCerts, fileClientCerts, fileClientKey);
    }
     ...
     * @throws DpGrpcException  general gRPC resource or connection exception (see detail and cause)
     */
    public static IIngestionStream connectStream(
            String  strHost, 
            int     intPort, 
            File    fileTrustedCerts,
            File    fileClientCertsChain,
        ...
        return FAC_STREAM.connect(strHost, intPort, fileTrustedCerts, fileClientCertsChain, fileClientKey, bolPlainText, intMsgSizeMax, bolKeepAlive, bolGzipCompr, lngTimeout, tuTimeout);
    }
