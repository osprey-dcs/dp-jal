...
import com.ospreydcs.dp.jal.ingest.model.frame.IngestionFrameConverter;
import com.ospreydcs.dp.jal.ingest.model.frame.IngestionFrameDecomposer;
...
//    
     ...
     * </p>
     * 
     * @param bolEnable <code>true</code> enables data column serialization, <code>false</code> disables data column serialization
     */
    synchronized
    public void enableDataColumnSerialization(boolean bolEnable) {
        this.prcrFrmCnvrtr.enableSerialization(bolEnable);
    }
    ...
    /**
     *
     * @see @see com.ospreydcs.dp.jal.ingest.IIngestionService#getRequestIds()
     */
    @Override
