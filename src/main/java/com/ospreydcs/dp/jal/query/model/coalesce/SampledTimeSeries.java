...
//            throw new IllegalArgumentException("Data value type unassignable to requested type " + enmType);
    ...
    /**
     * @see com.ospreydcs.dp.jal.model.IDataColumn#getName()
     */
    @Override
    ...
    /**
     * @see com.ospreydcs.dp.jal.model.IDataColumn#getValues()
     */
    @Override
    @SuppressWarnings("unchecked")
    ...
    /**
     * @see com.ospreydcs.dp.jal.model.IDataColumn#getValuesTyped()
     */
    @Override
