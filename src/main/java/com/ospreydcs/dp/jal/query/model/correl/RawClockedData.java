...
public class RawClockedData extends RawCorrelatedData {
    ...
    /**
     * @see com.ospreydcs.dp.jal.query.model.correl.RawCorrelatedData#getSampleCount()
     */
    @Override
    ...
    /**
     * @see com.ospreydcs.dp.jal.query.model.correl.RawCorrelatedData#computeRawTmsAllocation()
     */
    @Override
    ...
    /**
     * @see com.ospreydcs.dp.jal.query.model.correl.RawCorrelatedData#getTimestampVector()
     */
    @Override
    ...
    /**
     * @see com.ospreydcs.dp.jal.query.model.correl.RawCorrelatedData#insertBucketData(com.ospreydcs.dp.grpc.v1.query.QueryDataResponse.QueryData.DataBucket)
     */
    @Override
    synchronized
