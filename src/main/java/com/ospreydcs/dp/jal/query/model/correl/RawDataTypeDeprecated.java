 ...
 * File:	RawDataTypeDeprecated.java
 * Package: com.ospreydcs.dp.jal.query.model.correl
 * Type: 	RawDataTypeDeprecated
 *
...
public enum RawDataTypeDeprecated {
    ...
    RawDataTypeDeprecated(Class<? extends RawCorrelatedData> clsType) {
