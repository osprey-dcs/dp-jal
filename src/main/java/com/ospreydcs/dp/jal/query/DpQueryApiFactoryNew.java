 ...
 * File:	DpQueryApiFactoryNew.java
 * Package: com.ospreydcs.dp.jal.query
 * Type: 	DpQueryApiFactoryNew
 *
...
import com.ospreydcs.dp.jal.query.impl.DpQueryServiceApiFactoryNew;

/**
 * <p>Connection factory for Data Platform Query Service APIs</p>
 * <p>
 * Connection factory supplying the Java applications programming interfaces to the Data Platform Query Service.
 * This is a utility class, essentially a convenience class, supplying all static methods for retrieval of
 * Query Service interfaces.  All operations are deferred to the class singleton <code>{@link FAC_INSTANCE}</code> 
 * which is an instance of <code>DpQueryServiceApiFactoryNew</code>. 
 * </p>
 * <p>
 ...
 *
 */
public class DpQueryApiFactoryNew {
    ...
    private static final DpQueryServiceApiFactoryNew   FAC_INSTANCE = DpQueryServiceApiFactoryNew.FACTORY;
    ...
    public static IQueryService    connect(String strHostUrl, int intHostPort) throws DpGrpcException {
        return FAC_INSTANCE.connect(strHostUrl, intHostPort);
    }
    ...
    public static IQueryService    connect(String strHostUrl, int intHostPort, boolean bolPlainText) throws DpGrpcException {
        return FAC_INSTANCE.connect(strHostUrl, intHostPort, bolPlainText);
    }
    ...
    public static IQueryService    connect(String strHostUrl, int intHostPort, boolean bolPlainText, long lngTimeout, TimeUnit tuTimeout) throws DpGrpcException {
        return FAC_INSTANCE.connect(strHostUrl, intHostPort, bolPlainText, lngTimeout, tuTimeout);
    }
    ...
    public static IQueryService    connect(String strHostUrl, 
        ...
        return FAC_INSTANCE.connect(strHostUrl, intHostPort, bolTisActive, bolPlainText, intMsgSizeMax, bolKeepAlive, bolGzipCompr, lngTimeout, tuTimeout);
    }
    ...
    public static IQueryService    connect(File fileTrustedCerts, File fileClientCerts, File fileClientKey) throws DpGrpcException {
        return FAC_INSTANCE.connect(fileTrustedCerts, fileClientCerts, fileClientKey);
    }
    ...
    public static IQueryService connect(String strHostUrl, int intHostPort, File fileTrustedCerts, File fileClientCerts, File fileClientKey) throws DpGrpcException {
        ...
        return FAC_INSTANCE.connect(strHostUrl, intHostPort, fileTrustedCerts, fileClientCerts, fileClientKey);
    }
    ...
    public static IQueryService connect(
        ...
        return FAC_INSTANCE.connect(strHost, intPort, fileTrustedCerts, fileClientCertsChain, fileClientKey, bolPlainText, intMsgSizeMax, bolKeepAlive, bolGzipCompr, lngTimeout, tuTimeout);
    }
    ...
    /**
     * <p>
     * Prevent construction of <code>DpQueryApiFactoryNew</code> instances.
     * </p>
     *
     */
    private DpQueryApiFactoryNew() {
    }
