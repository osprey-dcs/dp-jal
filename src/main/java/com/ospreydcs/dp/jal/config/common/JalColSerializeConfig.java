/*
 * Project: dp-jal
 * File:	JalColSerializeConfig.java
 * Package: com.ospreydcs.dp.jal.config.common
 * Type: 	JalColSerializeConfig
 *
 ...
 *
 */
public class JalColSerializeConfig extends CfgStructure<JalColSerializeConfig> {

    /** Default constructor required for base class */
    public JalColSerializeConfig() { super(JalColSerializeConfig.class);  }
