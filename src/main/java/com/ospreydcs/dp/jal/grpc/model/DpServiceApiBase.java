 ...
 * Package: com.ospreydcs.dp.jal.grpc.model
 ...
 * <code>{@link #shutdown()}</code> or <code>{@link #shutdownNow()}</code>.  Otherwise gRPC resources are not
...
//    protected DpServiceApiBase(DpGrpcConnection<ServiceGrpc, BlockStub, FutureStub, AsyncStub> conn) {
    ...
    /**
     * @see @see com.ospreydcs.dp.jal.grpc.model.IConnection#shutdownSoft()
     */
    @Override
    ...
    /**
     * @see @see com.ospreydcs.dp.jal.grpc.model.IConnection#shutdownNow()
     */
    @Override
    ...
    /**
     * @see @see com.ospreydcs.dp.jal.grpc.model.IConnection#awaitTermination(long, java.util.concurrent.TimeUnit)
     */
    @Override
...
//    }
    ...
    /**
     * @see @see com.ospreydcs.dp.jal.grpc.model.IConnection#isShutdown()
     */
    @Override
    ...
    /**
     * @see @see com.ospreydcs.dp.jal.grpc.model.IConnection#isTerminated()
     */
    @Override
