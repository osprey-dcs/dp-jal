...
import com.ospreydcs.dp.jal.grpc.model.DpGrpcConnectionFactory;
...
public final class DpIngestionConnectionFactoryStatic{
     ...
     * </p>
     *
     * @see com.ospreydcs.dp.jal.grpc.DpGrpcConnectionFactory#connect()
     */
     ...
     * @throws DpGrpcException general gRPC resource creation exception (see message and cause)  
     * 
     * @see {@link com.ospreydcs.dp.jal.grpc.model.DpGrpcConnectionFactory#connect(String, int, boolean, long, TimeUnit)}
     */
