        ...
        DpIngestionServiceGrpc.DpIngestionServiceStub>
{
    ...
    private static final DpGrpcConnectionConfig   CFG_DEFAULT = JalConfig.getInstance().connections.ingestion;
    ...
    /**
     *
     * @see @see com.ospreydcs.dp.jal.grpc.model.DpGrpcConnectionFactoryBase#createFrom(com.ospreydcs.dp.jal.grpc.model.DpGrpcConnection)
     */
    @Override
