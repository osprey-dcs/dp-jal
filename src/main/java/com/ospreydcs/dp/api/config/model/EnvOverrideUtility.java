 ...
 * File:	EnvOverrideUtility.java
 * Package: com.ospreydcs.dp.api.config
 * Type: 	EnvOverrideUtility
 *
...
/**
 * <p>
 * Utility class supporting environment variable annotations <code>AEnvOverride</code> on structure
 ...
 *
 */
public final class EnvOverrideUtility {

    /**
     * <p>
     * Parses the fields in a structure class for the 
     * <code>AEnvOverride</code> annotations to determine the supported environment
     ...
     */
    public static List<EnvVariable> parse(Object objStruct) throws IllegalArgumentException, IllegalAccessException {
        ...
        for (Field fld : clsProps.getDeclaredFields()) {
            if (fld.isAnnotationPresent(AEnvOverride.Struct.class)) {
                ...
                lstVars.addAll( EnvOverrideUtility.parse(objFld) );
            }
            ...
            if (fld.isAnnotationPresent(AEnvOverride.Field.class)) {
                ...
                if ( !annFld.env().isBlank() ) {
                    ...
                    EnvVariable var = new EnvVariable(strVarNm, strVarVal, fld, objStruct);
     ...
     * those specified as environment variables using the <code>AEnvOverride</code> annotations.
     * </p>
     * <p>
     ...
     * is expected to be of a structure class type annotated with the <code>@AEnvOverride</code>
     * annotations. 
     * </p>
     * 
...
//            return false;
        ...
        for (Field fld : clsProps.getDeclaredFields()) {
            ...
            if (fld.isAnnotationPresent(AEnvOverride.Struct.class)) {
                ...
                if (EnvOverrideUtility.override(objFld))
                    bolResult = true;
