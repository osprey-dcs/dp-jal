...
/**
 * <p>
 * Represents a collection of <code>CorrelatedRawData</code> instances that have intersecting time ranges.
 * </p>
 * <p>
 * This class is intended as an intermediate object in the processing of <code>CorrelatedRawData</code> instances
 * with time domain collisions.  Once built class instances should contain a collection of all the 
 * <code>CorrelatedRawData</code> instances within a query response having a non-emtpy time range intersection.
 * Note there can be multiple but separate <code>RawDataSuperDomain</code> collections within the same query response.  
 * </p>
 * <p>
 * Once the <code>RawDataSuperDomain</code> collection is established, a "super domain" is defined.  This super domain
 ...
 *
 */
public class RawDataSuperDomain {
    ...
    /**
     * <p>
     * Creates a new, empty <code>RawDataSuperDomain</code> instance.
     * </p>
     * 
     * @return  a new <code>RawDataSuperDomain</code> instance containing no data (empty)
     */
    public static RawDataSuperDomain   create() {
        return new RawDataSuperDomain();
    }
    
    /**
     * <p>
     * Constructs a new <code>RawDataSuperDomain</code> instance initially populated with the given data block.
     * </p>
     *
     * @param datFirst  the first <code>CorrelatedRawData</code> block within the collection
     * 
     * @return  a new <code>RawDataSuperDomain</code> instance containing the single data block
     */
    public static RawDataSuperDomain   from(CorrelatedRawData datFirst) {
        return new RawDataSuperDomain(datFirst);
    }
    ...
    private final Set<CorrelatedRawData>  setRawData = new TreeSet<>(); 
    ...
    /**
     * <p>
     * Constructs a new, empty <code>RawDataSuperDomain</code> instance.
     * </p>
     */
    public RawDataSuperDomain() {
    }
    
    /**
     * <p>
     * Constructs a new <code>RawDataSuperDomain</code> instance initially populated with the single argument.
     * </p>
     *
     * @param datFirst  the first <code>CorrelatedRawData</code> block within the collection
     */
    public RawDataSuperDomain(CorrelatedRawData datFirst) {
    ...
    /**
     * <p>
     * Determines whether or not the given argument has a disjoint time with the current super domain.
     * </p>
     * 
     * @param datRaw    the <code>CorrelatedRawData</code> block under comparison
     * 
     ...
     */
    public boolean  isDisjoint(CorrelatedRawData datRaw) {
     ...
     * <code>RawDataSuperDomain</code> collection in its current state.
     * </p>
     * <p>
     ...
     */
    public boolean  add(CorrelatedRawData datRaw) {
