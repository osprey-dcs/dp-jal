 ...
 * File:	QueryRequestProcessorOld.java
 * Package: com.ospreydcs.dp.api.query.model.correl
 * Type: 	QueryRequestProcessorOld
 *
 ...
 * </p>
 * <p>
 * The <code>QueryRequestProcessorOld</code> class performs 2 functions: 1) time-series data request recovery 
 ...
 * <code>{@link CorrelatedQueryDataOld}</code> objects. That is, <code>QueryRequestProcessorOld</code> class 
 ...
 * </p>
 * <p>
 * All supported Query Service data requests within <code>QueryRequestProcessorOld</code> are implemented by 
 ...
 * It is important to note that clients of the <code>QueryRequestProcessorOld</code> data request methods must 
 * perform all final processing of the correlated output BEFORE invoking another data request.  Correlated data
 * output sets are <em>owned</em> by the <code>QueryRequestProcessorOld</code> object performing the request.
 ...
 * <code>QueryRequestProcessorOld</code> object are configurable.  Optimal configurations are determined by
 ...
 * <code>{@link QueryDataCorrelatorOld}</code> instance within each <code>QueryResultProcessor</code> object.
...
public class QueryRequestProcessorOld {
     ...
     * </p>
     *
     * @return  a new <code>QueryRequestProcessorOld</code> instance ready for correlation of data requests
     */
    public static QueryRequestProcessorOld    from(DpQueryConnection connQuery) {
        return new QueryRequestProcessorOld(connQuery);
    }
    ...
    private final QueryDataCorrelatorOld       prcrCorrelator;
...
//    private double  dblRateProcessed = 0;
     ...
     */
    public SortedSet<CorrelatedQueryDataOld>   processRequest(DpDataRequest dpRequest) throws DpQueryException {
...
//        List<DpDataRequest>     lstRequests;
     ...
     */
    public SortedSet<CorrelatedQueryDataOld>   processRequests(List<DpDataRequest> lstRequests) throws DpQueryException {
        ...
        SortedSet<CorrelatedQueryDataOld>  setPrcdData = this.prcrCorrelator.getCorrelatedSet();
...
//        return List.of(dpRequest);
     ...
     * However, data correlation can be enabled after returning (depending upon the state of the message
     * transfer task).
     * </p>
     * <p>
    ...
    private int correlateResponseData() throws DpQueryException {
        ...
        try {
            this.thdMsgXferTask.join( QueryRequestProcessorOld.timeoutLimitDefaultMillis() );
