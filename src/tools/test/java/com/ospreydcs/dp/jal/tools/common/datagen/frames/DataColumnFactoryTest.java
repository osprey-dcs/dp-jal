...
public class DataColumnFactoryTest {
    ...
    public final void testFromFail() {
        ...
        try {
            ...
            Assert.fail("DataColumnFactory creation/construction should have thrown IllegalArgumentException: column size = " + szCol);
...
//    /**
//     * Test method for {@link com.ospreydcs.dp.jal.tools.common.datagen.frames.DataColumnFactory#getColumnName()}.
//     */
//    @Test
...
//
//    /**
//     * Test method for {@link com.ospreydcs.dp.jal.tools.common.datagen.frames.DataColumnFactory#getColumnSize()}.
//     */
//    @Test
...
//
//    /**
//     * Test method for {@link com.ospreydcs.dp.jal.tools.common.datagen.frames.DataColumnFactory#getColumnType()}.
//     */
//    @Test
...
//    }
    ...
    public final void testBuildDoubleIncr1em16() {
        ...
        final int               szCol = 10;
        final ScalarFactoryEnum   enmFac = ScalarFactoryEnum.DOUBLE_INCR_EM16;
        final ScalarFactory     facVals = enmFac.newFactory();
        final DpSupportedType   enmType = enmFac.getDpType();
        final Double            dblIncr = enmFac.getConfiguration().increment().doubleValue();
        final Double            dblSeed = (double) enmFac.getConfiguration().seed();
        final int               cntCols = 10;
    ...
    public final void testBuildDoubleRnd() {
        ...
        final int               szCol = 10;
        final ScalarFactoryEnum   enmFac = ScalarFactoryEnum.DOUBLE_RND;
        final ScalarFactory     facVals = enmFac.newFactory();
        final DpSupportedType   enmType = enmFac.getDpType();
        final int               cntCols = 10;
