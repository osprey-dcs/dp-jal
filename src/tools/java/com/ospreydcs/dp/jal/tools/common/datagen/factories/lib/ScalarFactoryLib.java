 ...
 * </p>
 * <p>
 * This is a convenience enumeration that provides constants for common <code>ScalarFactorySpec</code> configuration
 ...
 *
 */
public enum ScalarFactoryLib {
    
    /**
     * The default <code>ScalarFactory</code> configuration as defined in the JAL default configuration.
     */
    DEFAULT( ScalarFactorySpec.from() ),

    /**
     * A string factory whose string suffix starts at 0 then increments by 1.
     */
    STRING_INCR_1( ScalarFactorySpec.from( JalScalarType.STRING, false, 0, Integer.valueOf(1)) ),
    
    /**
     * A string factory whose string suffix starts at 0 then increments by 2.
     */
    STRING_INCR_2( ScalarFactorySpec.from( JalScalarType.STRING, false, 0, Integer.valueOf(2)) ),

    /**
     * A string factory whose string suffixes are randomly generated integers.
     */
    STRING_INCR_RND( ScalarFactorySpec.from( JalScalarType.STRING, true, 0) ),

    /**
     * A boolean value factory which always produces <code>false</code>.
     */
    BOOLEAN_FALSE( ScalarFactorySpec.from(JalScalarType.BOOLEAN, false, 0, Integer.valueOf(0)) ),
    
    /**
     * A boolean value factory which always produces <code>true</code>.
     */
    BOOLEAN_TRUE( ScalarFactorySpec.from(JalScalarType.BOOLEAN, false, 1, Integer.valueOf(0)) ),
    
    /**
     * A boolean value factory which starts at <code>false</code> then alternates.
     */
    BOOLEAN_ALT( ScalarFactorySpec.from(JalScalarType.BOOLEAN, false, 0, Integer.valueOf(1)) ),

    /**
     * A boolean value factory which produces random boolean values.
     */
    BOOLEAN_RND( ScalarFactorySpec.from(JalScalarType.BOOLEAN, true, 0) ),

    /**
     * An integer value factory whose initial value is 0 then increments by 1.
     */
    INTEGER_INCR_1( ScalarFactorySpec.from(JalScalarType.INTEGER, false, 0, Integer.valueOf(1)) ),
    
    /**
     * An integer value factory whose initial value is 0 then increments by 2.
     */
    INTEGER_INCR_2( ScalarFactorySpec.from(JalScalarType.INTEGER, false, 0, Integer.valueOf(2)) ),
    
    /**
     * An integer value factory whose initial value is 0 then increments by 3.
     */
    INTEGER_INCR_3( ScalarFactorySpec.from(JalScalarType.INTEGER, false, 0, Integer.valueOf(3)) ),
    
    /**
     * An integer value factory that produces random integer values.
     */
    INTEGER_RND( ScalarFactorySpec.from(JalScalarType.INTEGER, true, 0) ),
    
    /**
     * A long value factory whose initial value is 0 then increments by 1.
     */
    LONG_INCR_1( ScalarFactorySpec.from(JalScalarType.LONG, false, 0, Long.valueOf(1)) ),
    
    /**
     * A long value factory whose initial value is 0 then increments by 2.
     */
    LONG_INCR_2( ScalarFactorySpec.from(JalScalarType.LONG, false, 0, Long.valueOf(2)) ),
    
    /**
     * A long value factory whose initial value is 0 then increments by 3.
     */
    LONG_INCR_3( ScalarFactorySpec.from(JalScalarType.LONG, false, 0, Long.valueOf(3)) ),
    
    /**
     * A long value factory that produces random long values.
     */
    LONG_RND( ScalarFactorySpec.from(JalScalarType.LONG, true, 0) ),
    
    /**
     * A float value factory whose initial value is 0 then increments by 0.1.
     */
    FLOAT_INCR_P1( ScalarFactorySpec.from(JalScalarType.FLOAT, false, 0, Float.valueOf(0.1f)) ),
    
    /**
     * A float value factory whose initial value is 0 then increments by 0.2.
     */
    FLOAT_INCR_P2( ScalarFactorySpec.from(JalScalarType.FLOAT, false, 0, Float.valueOf(0.2f)) ),
    
    /**
     * A float value factory whose initial value is 0 then increments by 0.01.
     */
    FLOAT_INCR_P01( ScalarFactorySpec.from(JalScalarType.FLOAT, false, 0, Float.valueOf(0.01f)) ),
    
    /**
     * A float value factory that produces random floating point values in [0, 1].
     */
    FLOAT_RND( ScalarFactorySpec.from(JalScalarType.FLOAT, true, 0) ),
    
    /**
     * A double value factory whose initial value is 0 then increments by 0.1.
     */
    DOUBLE_INCR_P1( ScalarFactorySpec.from(JalScalarType.DOUBLE, false, 0, Double.valueOf(0.1)) ),
    
    /**
     * A double value factory whose initial value is 0 then increments by 0.01. 
     */
    DOUBLE_INCR_P01( ScalarFactorySpec.from(JalScalarType.DOUBLE, false, 0, Double.valueOf(0.01)) ),
    
    /**
     * A double value factory whose initial value is 0 then increments by 0.001.
     */
    DOUBLE_INCR_P001( ScalarFactorySpec.from(JalScalarType.DOUBLE, false, 0, Double.valueOf(0.001)) ),
    
    /**
     * A double value factory whose initial value is 0 then increments by 1.0e-16.
     */
    DOUBLE_INCR_EM16( ScalarFactorySpec.from(JalScalarType.DOUBLE, false, 0, Double.valueOf(1.0e-16)) ),
    
    /**
     * A double value factory that produces random double values in [0, 1].
     */
    DOUBLE_RND( ScalarFactorySpec.from(JalScalarType.DOUBLE, true, 0) ),
    ...
    private final ScalarFactorySpec   recCfg;
    ...
    /**
     * <p>
     * Constructs a new <code>ScalarFactoryLib</code> instance for the given <code>ScalarFactorySpec</code> record.
     * </p>
     *
     * @param recCfg    the <code>{@link ScalarFactorySpec}</code> record associated with this constant
     */
    private ScalarFactoryLib(ScalarFactorySpec recCfg) {
        this.recCfg = recCfg;
    }
    ...
    /**
     * <p>
     * Returns the <code>ScalarFactorySpec</code> configuration record associated with this constant
     * </p>
     * 
     * @return  the <code>{@link ScalarFactorySpec}</code> record provided at constant construction
     * 
     * @see ScalarFactorySpec
     */
    public ScalarFactorySpec  getConfiguration() {
        return this.recCfg;
    }
    ...
    public JalScalarType    getJalType() {
        return this.getConfiguration().enmType();
    }
     ...
     * with this <code>ScalarFactoryLib</code> enumeration constant.  The scalar factory is ready for
