...
import com.ospreydcs.dp.jal.tools.common.datagen.values.StructureGenerator;
 ...
 * Protobuf message in <em>common.proto</em>.  The class <code>{@link StructureGenerator}</code> will
 ...
 * created by <code>StructureGenerator</code>.  More specifically, the class generates the index sets for the
 * <em>terminal nodes</em> of the symmetric tree structures created by <code>StructureGenerator</code>.
 * The terminal nodes of structures created by <code>StructureGenerator</code> contain scalar values of type 
...
//        this.lstTotalIndexCurr = this.initTotalIndexCounter();
     ...
     * by <code>{@link StructureGenerator}</code>.
     * </p> 
     *  
