...
public final class RequestDecompConfigScorer extends ConfigScorerBase<
                ...
                com.ospreydcs.dp.jal.tools.apps.query.recovery.RequestDecompConfigScorer.Score> 
{
...
//        }
     ...
     */
    @Override
    protected com.ospreydcs.dp.jal.tools.apps.query.recovery.RequestDecompConfigScorer.Score newScore(RequestDecompConfig recConfig) {
