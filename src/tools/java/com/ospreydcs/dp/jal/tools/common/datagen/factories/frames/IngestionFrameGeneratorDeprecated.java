 ...
 * File:	IngestionFrameGeneratorDeprecated.java
 * Package: com.ospreydcs.dp.jal.tools.common.datagen.factories.frames
 * Type: 	IngestionFrameGeneratorDeprecated
 *
 ...
 * </p>
 * <p>
 * A single class instance of <code>IngestionFrameGeneratorDeprecated</code> can create multiple <code>IngestionFrame</code>
...
public class IngestionFrameGeneratorDeprecated {
    ...
    /**
     * <p>
     * Creates and returns a new <code>IngestionFrameGeneratorDeprecated</code> instance configured from the given record.
     * </p>
     * <p>
     * The new <code>IngestionFrameGeneratorDeprecated</code> is fully operational after construction.  Use the
     ...
     * 
     * @return  a new <code>IngestionFrameGeneratorDeprecated</code> instance ready from <code>IngestionFrame</code> creation
     * 
    ...
    public static final String  STR_SRC_NAME = IngestionFrameGeneratorDeprecated.class.getSimpleName();
    ...
    private static final Logger LOGGER = Log4j.getLogger(IngestionFrameGeneratorDeprecated.class, STR_LOGGING_LEVEL);
...
//    private final SampleBlockConfig recCfg;
    ...
    private final DataColumnGeneratorDeprecated   genCols;
    ...
    /**
     * <p>
     * Constructs a new <code>IngestionFrameGeneratorDeprecated</code> instance configured from the given record.
     * </p>
     * <p>
     * The new <code>IngestionFrameGeneratorDeprecated</code> is fully operational after construction.  Use the
     * <code>{@link #build()}</code> method to create new <code>IngestionFrame</code> instances as
...
//        this.recCfg = recCfg;
        ...
        this.genCols = DataColumnGeneratorDeprecated.from(recCfg);
    }
