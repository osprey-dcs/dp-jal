...
public class TestArchiveRequestCreator {
    ...
    private static final String STR_ISO_ARCHIVE_INCEPT = CFG_ARCHIVE.range.start; // "2023-10-31T15:51:02.000+00:00";
    
    /** The ISO 8601 format last timestamp instant within the test data archive */
    private static final String STR_ISO_ARCHIVE_LAST = CFG_ARCHIVE.range.end; // "2023-10-31T15:51:21.999+00:00"; 
