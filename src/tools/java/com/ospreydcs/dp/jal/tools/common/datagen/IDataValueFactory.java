...
public interface IDataValueFactory {
    ...
    /**
     * <p>
     * Returns the value of of the simulated data returned by <code>{@link #nextValue()}</code>.
     * </p>
     * <p>
     * Returns the type constant in enumeration <code>{@link DpSupportedType}</code> of the value
     * generated by this data value factory.
     * </p> 
     * 
     * @return  the enumeration constant representing the value types returned by <code>{@link #nextValue()}</code>
     */
