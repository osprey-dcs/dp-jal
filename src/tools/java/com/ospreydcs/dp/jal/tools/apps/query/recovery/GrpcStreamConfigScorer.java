 ...
 * Package: com.ospreydcs.dp.jal.tools.apps.query.recovery
...
public class GrpcStreamConfigScorer extends 
                ...
                com.ospreydcs.dp.jal.tools.apps.query.recovery.GrpcStreamConfigScorer.Score> 
{
...
//        }
        ...
        protected String extractDataSourceId(QueryRecoveryTestResult recResult) {
            return recResult.rqstOrg().getRequestId();
        }
     ...
     */
    @Override
    protected com.ospreydcs.dp.jal.tools.apps.query.recovery.GrpcStreamConfigScorer.Score newScore(GrpcStreamConfig recConfig) {
