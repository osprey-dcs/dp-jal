 ...
 *
 */
public class DataColumnsFactory {
     ...
     */
    public static final DataColumnsFactory   from(Set<String> setColNms, int szCols, IDataValueFactory facValues) throws IllegalArgumentException {
        return new DataColumnsFactory(setColNms, szCols, facValues);
    }
     ...
     * @throws IllegalArgumentException either empty name collection, column size < 1, or value factory is <code>null</code>
     */
    public DataColumnsFactory(Set<String> setColNms, int szCols, IDataValueFactory facValues) throws IllegalArgumentException {
     ...
     * data factory <code>{@link IDataValueFactory}</code> provided at creation/construction.
     * </p>
     * 
