 ...
 * the utility class <code>DpTestArchiveRequestCreator</code>.
 * </p>
 * <p>
 * Record contains fields for creating a test request with the 
 * <code>{@link DpTestArchiveRequestCreator}</code> utility.  
 * </p>
 * <p>
        ...
        ) 
{
    ...
    public DpDataRequest    createRequest() throws IllegalArgumentException {
        ...
        DpDataRequest rqst = DpTestArchiveRequestCreator.createRequest(this.enmRqstType, 
                                                          this.cntDataSources, 
