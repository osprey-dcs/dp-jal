...
public class CorrelationConfigScorer extends 
            ConfigScorerBase<CorrelationConfig, 
                             ...
                             com.ospreydcs.dp.jal.tools.apps.query.recovery.CorrelationConfigScorer.Score> 
{
...
//        }
    ...
    @Override
    protected com.ospreydcs.dp.jal.tools.apps.query.recovery.CorrelationConfigScorer.Score newScore(CorrelationConfig recConfig) {
