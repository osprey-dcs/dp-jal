 ...
 * Package: com.ospreydcs.dp.jal.tools.apps.query.superdom
...
public class SuperDomTestSuiteCreator {
     ...
     * <code>{@link TestArchiveRequest#createRequest()}</code> will be supplemented with the given PV names,
     ...
     * <code>TestArchiveRequest</code> in the configuration.  Specifically, the data request generated by
     * <code>{@link TestArchiveRequest#createRequest()}</code> will be supplemented with the given PV name
     * more specifically, all PV names added to the current configuration.
     * </p>
     * 
    ...
    public Collection<SuperDomTestCase> createTestSuite() throws ConfigurationException {
        ...
        List<SuperDomTestCase>  lstCases = new ArrayList<>(this.setTestRqsts.size());
     ...
     * </p>
     * <p>
     * The base request is formed using the method <code>{@link TestArchiveRequest#createRequest()}</code>.  The following
